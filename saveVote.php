    ...
    <div class="container" style="padding-top:150px;">
    	<div class="row">
          ...
          require('config.php');
					...
					{
						$name = test_input($_POST["voterName"], $conn);
            $email = test_input($_POST["voterEmail"], $conn);
            $voterID = test_input($_POST["voterID"], $conn);
            $selection = test_input($_POST["selectedCandidate"], $conn);
